...
@section('main-content')
	<!-- BEGIN MAIN CONTENT -->
		...
		<div class="item">
			...
			<img src="/assets/images/no-img.jpg" width="1349" height="516" alt="No Image Found">
			@else
			...
			<div class="container">
				...
				<div class="release-book-detail h-white p-white">
						<div class="release-book-slider">
							...
							<div class="item">
								<div class="detail">
									<h5><a href="{{ route('book.show',['slug' => $upcoming_book->slug]) }}">{{ $upcoming_book->title }}</a></h5>
									<p>{{ Str::limit($upcoming_book->description, 100, '...') }}</p>
									<span>Rs/ {{ number_format($upcoming_book->price) }}</span>
									<i class="fa fa-angle-double-right"></i>
								</div>
								<div class="detail-img">
									@if($upcoming_book->book_img == 'No image found' )
									<img src="/assets/images/no-img.jpg" width="112" height="156" alt="No image found">
									@else
                        ...
                        @foreach($upcoming_books as $key => $upcoming_book)
							<li>
								<a data-slide-index="{{ $key }}" href="#">
									<span>{{ Str::limit($upcoming_book->title, 10, '...') }}</span>
									@if($upcoming_book->book_img == 'No image found')
									<img src="/assets/images/no-img.jpg" width="94" height="122" alt="No image found">
									@else
									<img src="/uploads/{{ $upcoming_book->book_img }}" width="94" height="122" alt="No image found">
									@endif
			    			...
			    			<div class="item">
			    				<div class="product-box">
			    					...
			    					<div class="product-detail">
			    						@if ($downloaded_book->author)
									    <span>{{ $downloaded_book->author->title }}</span>
									@endif
			    						<h5><a href="{{ route('book.show',['slug' => $downloaded_book->slug]) }}">{{ $downloaded_book->title }}</a></h5>
			    						...
			    						<div class="aurthor-detail">
			    							@if ($downloaded_book->author)
			    							<span><img src="/assets/images/book-aurthor/img-01.jpg" alt="">
				...
				<div class="recomend-slider">
                  @forelse($recommended_books as $recommended_book)
					...
					<div class="item">
						...
						<img src="/assets/images/no-img.jpg" width="109" height="150" alt="No image found">
						@else
						...
						<div class="col-lg-9 col-sm-12">
							<div class="collection">
											...
											<div class="s-product">
												<div class="s-product-img">
													@if($book->book_img == 'No image found')
                                                        <img src="/assets/images/no-img.jpg" width="145" height="209" alt="No image found">
                                                    @else
                                                        <img src="/uploads/{{ $book->book_img }}"  width="145" height="209" alt="{{ $book->title }}">
                                                    @endif    
													<div class="s-product-hover"></div>
												</div>
												<h6><a href="{{ route('book.show',['slug' => $book->slug]) }}">{{ Str::limit($book->title, 15, '...') }}</a></h6>
												@if($book->author)
								...
								<div class="pagination-holder">
									{{ $books->links('pagination.paginate') }}	
								</div>
								<!-- Pagination -->
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-12">
						<div class="aurthor-img">
							...
							<img src="/assets/images/no-img.jpg" alt="No image found" width="243" height="344">
							@else
								...
								<li id="1985">
									<div class="text-box">
										...
										<ul class="s-related-products">
											@foreach($author_feature->author_books as $keys => $author_book)
											@if($key < 3)
											<li>
												<img src="/assets/images/no-img.jpg" alt="No image found" width="89" height="119">
												@else
			            ...
			            <ul>
			                ...
			                <li>
			                  	<div class="gallery-figure"> 
			                  		...
			                  		<img src="/assets/images/no-img.jpg" width="242" height="187" alt="No Image Found">
			                  		@else
