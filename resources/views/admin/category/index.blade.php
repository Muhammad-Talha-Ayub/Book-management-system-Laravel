    ...
    <section class="content">
     ...
     <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"> 
                    <a id="activeAllStatus" url="{{ route('category.active.status') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye"></i></a>
                    <a id="deactiveAllStatus" url="{{ route('category.deactive.status') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye-slash"></i></a>
                    <a id="deleteAll" url="{{ route('category.delete.all') }}" class="btn btn-danger btn-xm"><i class="fa fa-trash"></i></a>
            ...
            <div class="box-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <td><input type="checkbox" name="statusAll[]" id="" class="checkSingle" value="{{ $category->id }}"></td>
                  <td>{{ $category->title }}</td>
                  <!-- $category->decrypted_attributes['title'] -->
                  <td>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <span style="display:block;font-size:15px;line-height:34px;margin:20px 0;">
                                      Showing {{($categorys->currentpage()-1)*$categorys->perpage()+1}} to {{$categorys->currentpage()*$categorys->perpage()}}
                        of  {{$categorys->total()}} entries</span>
                            </div>
