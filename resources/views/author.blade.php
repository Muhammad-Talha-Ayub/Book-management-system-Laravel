					...
					<div class="col-lg-9 col-md-8 col-xs-12">
						...
						<div class="authors-filter">
							<ul>
								...
								<li><a href="/author?letter={{ strtolower($letter) }}">{{ $letter }}</a></li>
								 @endforeach
							</ul>
						</div>
						<!-- Author Filter -->
							...
							<li>
								<div class="author-list-widget">
									<div class="arthor-list-img">
										...
										<img src="/assets/images/no-img.jpg" width="178" height="178" alt="No Image Found">
										@else
								...
								<li>
									<div class="s-arthor-wighet">
										<div class="s-arthor-img">
											...
											<img src="/assets/images/no-img.jpg" width="45" height="45" alt="No Image Found">
											@else
							...
							<ul class="books-year-list">
								...
								<li>
									<div class="books-post-widget">
										...
										<img src="/assets/images/no-img.jpg" width="54" height="73" alt="No image found">
										@else
