						...
						<div id="filter-masonry" class="gallery-masonry">	
							...
							<div class="book-list-widget masonry-grid business">
								...
								<div class="book-list-detail">
									...
									<img src="/assets/images/no-img.jpg" width="109" height="164" alt="No image found">
									@else
									...
									<div class="detail">
										...
										<div class="book-name">
											<h5>{{ $book->title }} <span>Cooking Book</span></h5><strong>Rs/ {{ number_format($book->price) }}</strong>
										</div>
